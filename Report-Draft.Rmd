...
model_function_group53 <- function() {
  ...
  #income from cocoa
  income_cocoa <- cocoa_farm_harvest_complete * cocoa_price_world_market_30 * cocoa_price_percent_farmgate_30*yield_impact
...
evpi_cocoatimber <- multi_EVPI(mc = mcSimulation_cocoa_income, 
                   first_out_var = "cocoa_price_world_market")
plot_evpi(evpi_cocoatimber, decision_vars = "cocoa_price_world_market")
