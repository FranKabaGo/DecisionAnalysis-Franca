...
#considering income
  ...
  cocoa_price_world_market_n <-
    vv(cocoa_price_world_market, 30, n_years)
...
#creating final cashflows and distributions
   final_cashflow <- (income_cocoa)/559+(income_timber)/559 - (overall_cost_cocoa+overall_cost_timber)/559
  # Generate the list of outputs from the Monte Carlo simulation
  final_result <- sum(income_cocoa/559+income_timber/559 - overall_cost_cocoa/559+overall_cost_timber/559)
